...
#
label_l1 = tk.Label(root, text="Agrospectra Intelligent crop prediction",font=("Times New Roman", 30, 'bold'),
                    background="#006400", fg="white", width=66, height=2)
...
button4 = tk.Button(label_l1, text="Home", command=home, width=7, height=1,font=('times', 15, ' bold underline'),bd=0, bg="#006400", fg="white")
button4.place(x=1155, y=50)
    
button1 = tk.Button(label_l1, text="About us", command=about, width=7, height=1,font=('times 15 bold underline'),bd=0, bg="#006400", fg="white")
button1.place(x=1240, y=50)

button2 = tk.Button(label_l1, text="Contact us",command=con,width=7, height=1,font=('times 15 bold underline'), bd=0,bg="#006400", fg="white")
button2.place(x=1340, y=50)


button4 = tk.Button(root, text="Exit", command=window, width=7, height=1,font=('times', 15, ' bold underline'), bg="#006400", fg="white")
button4.place(x=780, y=700)
