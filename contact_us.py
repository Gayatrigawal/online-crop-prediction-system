...
label_l1 = tk.Label(root, text="Crop Prediction Using Machine Learning",font=("Times New Roman", 30, 'bold'),
                    background="#006400", fg="white", width=65, height=2)
...
label_l2 = tk.Label(root, text="___ Contact us ___",font=("Times New Roman", 30, 'bold'),
                    background="#EEB422", fg="black", width=65, height=3)
label_l2.place(x=0, y=90)

img1 = Image.open('2.jpg')
img1 = img1.resize((1550,558), Image.ANTIALIAS)
...
frame_alpr.grid(row=0, column=0, sticky='nw')
frame_alpr.place(x=500, y=295)


label_l2 = tk.Label(frame_alpr, text="********** \n Call us \n (+91 8956529905,+91 9149486401) \n \n Location \n Pune, Maharashtra \n \n Email - agrospectracontact@gmail.com\n \n  **********",font=("Times New Roman", 20, 'italic'),
