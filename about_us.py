...
label_l2 = tk.Label(root, text="___ About us ___",font=("Times New Roman", 30, 'bold'),
                    background="#EEEE00", fg="black", width=65, height=3)
...
label_l2 = tk.Label(root, text="___ Crop Predication System ___",font=("Times New Roman", 20, 'bold'),
                    background="#006400", fg="white", width=53, height=3)
label_l2.place(x=706, y=232)
label_l2 = tk.Text(root,font=("Times New Roman", 15, 'italic'),
                    background="#006400", fg="white", width=82, height=22)
label_l2.place(x=706, y=340)
...
button4 = tk.Button(root, text="Contact us", command=con, width=10, height=1,font=('times', 15, ' bold'),bg="#EEEE00", fg="black")
button4.place(x=1050, y=700)
